...
#  Code added after 17_csv_dictwriter.py is ran producing
...
with open(filename, 'w', encoding='utf-8', newline='') as output_file:
    ...
    writer.writeheader()  # to get the headings
    # for row in medals_table:
    #     writer.writerow(row)
    writer.writerows(sorted(medals_table, key=sort_key))  # does the same as the loop above

# dictionaries can ne sorted with the sorted function
# but you need to create another function to sort the key
