...
As the dictreader produces dictionaries, the dictwriter
needs dictionaries to write to

The with statement can open a file for reading and open a
file for writing on the same line.

If you have very long lines, you can use the '\' to
tell Python the lines continues on the next line.

Opening one file for reading and another for writing
is a common thing to do in Python

This file creates medals_dict.py
"""
import csv
