...
if __name__ == '__main__':
    ...
    # ===== Artists Listbox =====
    artistList = DataListBox(mainWindow, conn, "artists", "name", background="lightyellow")
    ...
    albumList = DataListBox(mainWindow, conn, "albums", "name", sort_order=("name",), background="lightyellow")
    ...
    songList = DataListBox(mainWindow, conn, "songs", "title", ("track", "title"), background="lightyellow")
    # songList.requery()
